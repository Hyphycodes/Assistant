...
type AppContextValue = AppState & {
  ...
  addNote: (thingId: string, body: string, itemId?: string) => Promise<MutationResult>;
  ...
  addLink: (thingId: string, title: string, url: string, itemId?: string) => Promise<MutationResult>;
  ...
  addOption: (thingId: string, input: Omit<Option, "id" | "status">, itemId?: string) => Promise<MutationResult>;
...
export function AppProvider({ children, role, renderedAt }: { children: React.ReactNode; role: Role; renderedAt: string }) {
  ...
  const actions = useMemo(() => ({
    ...
    addNote: (thingId: string, body: string, itemId?: string) => command("add_note", { thingId, body, itemId }), updateNote: (thingId: string, noteId: string, body: string) => command("update_note", { thingId, noteId, body }), deleteNote: (thingId: string, noteId: string) => command("delete_note", { thingId, childId: noteId }),
    ...
    addLink: (thingId: string, title: string, url: string, itemId?: string) => command("add_link", { thingId, title, url, itemId }), updateLink: (thingId: string, linkId: string, title: string, url: string) => command("update_link", { thingId, linkId, title, url }), removeLink: (thingId: string, linkId: string) => command("remove_link", { thingId, childId: linkId }),
    addOption: (thingId: string, input: Omit<Option, "id" | "status">, itemId?: string) => command("add_option", { thingId, ...input, itemId: itemId ?? input.itemId }), updateOption: (thingId: string, optionId: string, input: Omit<Option, "id">) => command("update_option", { thingId, optionId, ...input }), removeOption: (thingId: string, optionId: string) => command("remove_option", { thingId, childId: optionId }), updateProductStatus: (thingId: string, optionId: string, status: Option["status"], reaction?: string) => command("update_product_status", { thingId, optionId, status, reaction }),
