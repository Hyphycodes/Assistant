...
type AppContextValue = AppState & {
  ...
  acceptProposal: (id: string, mode: "create" | "attach", sectionId?: string, itemType?: ThingItem["type"]) => Promise<MutationResult>;
...
export function AppProvider({ children, role, renderedAt }: { children: React.ReactNode; role: Role; renderedAt: string }) {
  ...
  const actions = useMemo(() => ({
    ...
    acceptProposal: (id: string, mode: "create" | "attach", sectionId?: string, itemType?: ThingItem["type"]) => command("accept_proposal", { id, mode, sectionId, itemType }),
